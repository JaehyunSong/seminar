...
　**オフィス・アワーの予約**や**応募者への課題**などは以下の「ゼミ応募」ボタンからご確認ください。
:::

<center>
<a href="entry/entry.html" class="btn btn-info btn-lg" role="button"><i class="bi bi-calendar-check"></i>&nbsp;&nbsp;&nbsp;ゼミ応募</a> 
<a href="https://www.instagram.com/song_officehour" class="btn btn-danger btn-lg" role="button" target="_blank"><i class="bi bi-instagram"></i>&nbsp;&nbsp;&nbsp;Instagram</a>
</center>
<center><span style="font-size:12px;">※ <a href="https://www.instagram.com/song_officehour" target="_blank">インスタグラム</a>の運営はゼミ生が行っており、宋は関与しておりません。</span></center>
...
　オフィス・アワーの予約やゼミ応募に関する情報は[【ここ】](entry/entry.qmd)をクリックしてください。

- メニューの「[応募 > 応募方法](entry/entry.qmd)」からもアクセスできます。
:::
-->
